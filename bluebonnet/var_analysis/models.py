...
class Evidence(models.Model):
    ...
    clinvar_id = models.CharField(max_length=50, editable = False)
    clinvar_interp = models.CharField(max_length=50, editable = False)
    clinvar_date = models.CharField(max_length=50, editable = False)
    clinvar_acc = models.CharField(max_length=50, editable = False)
    ...
    rsid = models.CharField(max_length=50, editable = False)
    pubmed = models.CharField(max_length=10000, default='')
    google = models.CharField(max_length=10000, default='')
