...
class Evidence(models.Model):
    ...
    gnomad = models.CharField(max_length=10000, default='')
    exac = models.CharField(max_length=10000, default='')
    dbsnp = models.CharField(max_length=10000, default='')
    clinvar = models.CharField(max_length=10000, default='')
    splice_sites = models.CharField(max_length=10000, default='')
    ...
    active_sites = models.CharField(max_length=10000, null=True, blank=True)
    additional_info = models.CharField(max_length=10000, null=True, blank=True)
    ...
    gnomad_comment = models.CharField(max_length=10000, default='', blank=True,null=True)
    ...
    exac_comment = models.CharField(max_length=10000, default='', blank=True,null=True)
    ...
    dbsnp_comment = models.CharField(max_length=10000, default='', blank=True,null=True)
    ...
    clinvar_comment = models.CharField(max_length=10000, default='', blank=True,null=True)
    ...
    splice_comment = models.CharField(max_length=10000, default='', blank=True,null=True)
    ...
    comp_comment = models.CharField(max_length=10000, default='', blank=True,null=True)
    ...
    active_sites_comment = models.CharField(max_length=10000, default='', blank=True,null=True)
    ...
    additional_comment = models.CharField(max_length=10000, default='', blank=True,null=True)
